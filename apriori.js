...
'use strict';
    ...
    (function (Apriori) {
        ...
        var Algorithm = (function () {
            function Algorithm(minSupport, minConfidence, maxItemSetSize, debugMode) {
                ...
                this.maxItemSetSize = maxItemSetSize ? maxItemSetSize === 0 ? 2 : maxItemSetSize : 2;
                ...
                var saveAssociationRuleIfFound = function (subsetItemSet) {
                    ...
                    if (diffItemSet.length > 0) {
                        ...
                        if (!isNaN(confidence) && !isTheRuleAlreadyFound(associationRules, subsetItemSet, diffItemSet) && confidence >= self.minConfidence) {
                            ...
                            //console.log(subsetItemSet, diffItemSet, itemSupport, confidence, lift);
